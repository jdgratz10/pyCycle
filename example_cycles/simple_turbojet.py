...
if __name__ == "__main__":
    ...
    print('DESIGN.inlet.Fl_O:stat:W', prob['DESIGN.inlet.Fl_O:stat:W'][0], 147.55302767907438)
    print('DESIGN.balance.FAR', prob['DESIGN.balance.FAR'][0], 0.017550780065132325)
    print('DESIGN.balance.turb_PR', prob['DESIGN.balance.turb_PR'][0], 3.876811007533011)
    print('DESIGN.perf.OPR', prob['DESIGN.perf.OPR'][0], 13.5)
    print('DESIGN.perf.Fg', prob['DESIGN.perf.Fg'][0], 11800.004972857632)
    print('DESIGN.perf.TSFC', prob['DESIGN.perf.TSFC'][0], 0.7900690482114057)
    print('DESIGN.comp.Fl_O:tot:T', prob['DESIGN.comp.Fl_O:tot:T'][0], 1190.1777648504044)
    print('OD0.inlet.Fl_O:stat:W', prob['OD0.inlet.Fl_O:stat:W'][0], 142.69375084217026)
    print('OD0.perf.OPR', prob['OD0.perf.OPR'][0], 12.840848747331666)
    print('OD0.balance.FAR', prob['OD0.balance.FAR'][0], 0.016651018104669776)
    print('OD0.balance.Nmech', prob['OD0.balance.Nmech'][0], 7936.36544281587)
    print('OD0.perf.Fg', prob['OD0.perf.Fg'][0], 11000.004885187022)
    print('OD0.perf.TSFC', prob['OD0.perf.TSFC'][0], 0.7775987704675483)
    print('OD0.comp.Fl_O:tot:T', prob['OD0.comp.Fl_O:tot:T'][0], 1169.5125213466022)
    print()
    ...
    print()
    print('DESIGN.burner.Fl_O:tot:T', prob['DESIGN.burner.Fl_O:tot:T'], 2370.0)
    ...
    print()
    print('DESIGN.fc.Fl_O:stat:gamma', prob['DESIGN.fc.Fl_O:stat:gamma'], 1.40019525)
    print('DESIGN.inlet.Fl_O:stat:gamma', prob['DESIGN.inlet.Fl_O:stat:gamma'], 1.40058022)
    print('DESIGN.comp.Fl_O:stat:gamma', prob['DESIGN.comp.Fl_O:stat:gamma'], 1.36872902)
    print('DESIGN.burner.Fl_O:stat:gamma', prob['DESIGN.burner.Fl_O:stat:gamma'], 1.30235009)
    print('DESIGN.turb.Fl_O:stat:gamma', prob['DESIGN.turb.Fl_O:stat:gamma'], 1.32500477)
    print()
    ...
    print()
    print('DESIGN.shaft.pwr_net', prob['DESIGN.shaft.pwr_net'], 0)
    print('DESIGN.burner.Fl_O:tot:T', prob.get_val('DESIGN.burner.Fl_O:tot:T', units='degR'), 2370.0)
    print('DESIGN.perf.Fn', prob.get_val('DESIGN.perf.Fn', units='lbf'), 11800)
    print()
    print('DESIGN.comp.trq', prob['DESIGN.comp.trq'], -22407.92995304)
    print('DESIGN.turb.trq', prob['DESIGN.turb.trq'], 22407.92995277)
    print()
    print('DESIGN.burner.Wfuel', prob['DESIGN.burner.Wfuel'], 2.58967074)
    print('DESIGN.burner.Wout', prob['DESIGN.burner.Wout'], 150.14269842)
    print('DESIGN.burner.mix_fuel.mass_avg_h', prob['DESIGN.burner.mix_fuel.mass_avg_h'], 156.00362128)

    print()
    print('DESIGN.burner.Fl_I:stat:W', prob['DESIGN.burner.Fl_I:stat:W'], 147.55302768)
    print('DESIGN.burner.Fl_O:stat:W', prob['DESIGN.burner.Fl_O:stat:W'], 150.14269842)
    print('DESIGN.burner.Fl_I:FAR', prob['DESIGN.burner.Fl_I:FAR'], 0.01755078)