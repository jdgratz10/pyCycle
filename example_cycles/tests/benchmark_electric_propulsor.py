...
class ElectricPropulsorTestCase(unittest.TestCase): 
    ...
    def benchmark_case1(self): 
        ...
        assert_near_equal(prob['design.fc.Fl_O:stat:W'], 315.344 , tol)
        assert_near_equal(prob['design.nozz.Fg'], 9653.170, tol)
        assert_near_equal(prob['design.fan.SMN'], 22.138, tol)
        assert_near_equal(prob['design.fan.SMW'], 18.956, tol)
