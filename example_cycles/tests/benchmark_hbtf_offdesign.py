...
class CFM56OffdesignTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.prob.set_val('OD.hpc.cool2:frac_W', 0.020274) #leave commented
        ...
        self.prob.set_val('OD.lpt.s_PR', 0.673736258118)#start
        self.prob.set_val('OD.lpt.s_Wp', 1.48034371393)
        self.prob.set_val('OD.lpt.s_eff', 0.974542303109)
        self.prob.set_val('OD.lpt.s_Np', 1.03027097635)#stop
...
#         # self.prob.set_val('OD.splitter.area1', 504.011122272, units='inch**2') #$weird error
#         # self.prob.set_val('OD.splitter.area2', 1882.18932965, units='inch**2') #$weird error
#         # self.prob.set_val('OD.duct4.area', 503.997116848, units='inch**2')
#         # self.prob.set_val('OD.lpc.area', 293.579637404, units='inch**2')
#         # self.prob.set_val('OD.duct6.area', 259.649232657, units='inch**2') #tolerance exceeded
